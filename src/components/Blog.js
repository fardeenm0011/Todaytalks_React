                    ...
                    <div className="col-md-12" key={post.id}>
                      <div className="weekly-post-three">
                        <div className="weekly-post-thumb">
                          ...
                          >
                            <img
                              src={
                                post.img
                                  ? IMAGE_BASE_URL + post.img
                                  : IMAGE_BASE_URL + DEFAULT_POST
                              }
                              alt={post.seo_slug}
                            />
                          </Link>
                        ...
                        >
                          ...
                          <h3
                            style={{
                              fontSize: "var(--tg-body-font-size)",
                              color: "var(--tg-icon-color)",
                              fontWeight: "var(--tg-body-font-weight)",
                            }}
                          >
                              ...
                              <li className="col-6">
                                ...
                                <div className="col-20">
                                  <Link
                                    to={""}
                                    onClick={() =>
                                      handleBlogArticleHeartClick(post.id)
                                    }
                                    className={
                                  ...
                                  >
                                    <FontAwesomeIcon
                                      icon={
                                        clickedBlogArticleIconId.includes(
                                          post.id
                                        )
                                          ? ["fas", "heart"]
                                          : ["far", "heart"]
